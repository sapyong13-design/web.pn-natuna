...
UPDATE pnn_content SET introtext='<div class="struktur-page">
  ...
  <section class="struktur-note-card">
    <strong>Catatan pembaruan</strong>
    <p>Data struktur organisasi perlu diverifikasi kembali sebelum publikasi produksi apabila terdapat perubahan pejabat atau unit kerja.</p>
  </section>
</div>', `fulltext`='' WHERE id=56;
COMMIT;

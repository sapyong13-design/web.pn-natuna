...
// LiteSpeed's v1.5.2 source still calls Joomla 3 global class names even
// though that release advertises Joomla 6 support. Keep the vendor logic
// intact while supplying only the aliases exercised by the system plugin.
foreach ([
